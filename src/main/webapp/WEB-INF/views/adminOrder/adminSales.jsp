...
<html>
  ...
  <body>
  	<button type="button" onclick="drawssChart()"class="btn btn-secondary col-2" id="day">일별</button>
  	<button type="button" onclick="drawsChart()" class="btn btn-secondary col-2">월별</button> 
