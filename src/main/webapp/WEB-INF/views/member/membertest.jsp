...
<form action="memberInsert" name="frm">
	...
	<input type="text" name="email" id="email" placeholder="이메일" onchange="idDupCheck()" />
	<br /> <br /> 
	PW <span id="alert-success" style="display: none;">비밀번호가 일치합니다.</span> <span id="alert-danger"
	...
	핸드폰 번호 <input type="text" name="phone" /><br /> <br /> 생년월일<input type="date"
		name="birthday" /><br /> <br />
