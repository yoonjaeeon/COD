  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="masterMain">
          ...
          <div class="bg-white py-2 collapse-inner rounded">
           ...
           <!--   <a class="collapse-item" href="adminMenuForm">메뉴관리</a>
            ...
            <a class="collapse-item" href="adminListForm">관리자 리스트</a>
             ...
             <a class="collapse-item" href="masterNoticeForm">공지사항</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Alerts -->
                <span class="badge badge-danger badge-counter" id="masterMessageCount"></span>
                <script>
            ...
            <!-- Nav Item - Messages -->
            <li class="nav-item dropdown no-arrow mx-1">
              <a class="nav-link dropdown-toggle" href="masterMessage" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
